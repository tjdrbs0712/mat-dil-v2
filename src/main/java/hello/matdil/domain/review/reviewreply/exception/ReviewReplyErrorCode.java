...
public enum ReviewReplyErrorCode implements ErrorCode {
    ALREADY_REVIEW_REPLY(400, "ALREADY_REVIEW_REPLY", "이미 등록된 리뷰 답글 입니다."),
    REVIEW_REPLY_NOT_FOUND(404, "REVIEW_REPLY_NOT_FOUND", "등록된 리뷰 답글이 없습니다."),
    NO_PERMISSION(403, "NO_PERMISSION", "리뷰 답글을 수정할 권한이 없습니다."),
    ALREADY_DELETED_REVIEW_REPLY(400, "ALREADY_DELETED_REVIEW_REPLY", "이미 삭제된 리뷰 답글 입니다."),
